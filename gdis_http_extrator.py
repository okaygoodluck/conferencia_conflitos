...
def coletar_manobras(opener, jsessionid, viewstate, situacao, malha=None):
    """
...
def extrair_uma_manobra(opener, jsessionid, viewstate, numero, malha=""):
    resp, vs = _pesquisar(opener, jsessionid, viewstate, situacao="", malha=malha, numero_manobra=numero, data_inicio="", data_fim="")
