...
def main():
    ...
    print("Coletando manobras 'Incompletas' (IN)...")
    incompleta, vs = coletar_manobras(opener, jsessionid, vs, "IN", "", "")
    ...
    todos = sorted(set(elaborada) | set(enviada) | set(incompleta) | set(aprovada) | set(concluida))
    print("\n--- TOTAIS ---")
    print(f"TOTAL EB: {len(elaborada)}")
    print(f"TOTAL EN: {len(enviada)}")
    print(f"TOTAL IN: {len(incompleta)}")
