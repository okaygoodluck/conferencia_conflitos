...
#### Regra 35 (Equipes em Campo)
Valida se manobras que indicam "EQUIPES:X" no cabeçalho possuem pelo menos um item executado pela "REGIAO".
*   **Exemplo ❌:** Cabeçalho indica 2 equipes, mas todas as ações são do COD.

#### Regra 36 (Sincronismo de Horário)
Cruza o horário de cada item individual com o horário definido no cabeçalho da etapa. Ignora itens com horário vazio.
*   **Exemplo ❌:** Etapa marcada para 08:00, mas item específico preenchido como 09:00.

#### Regra 37 (Executor MA60)
Garante que a macro MA60 (Chave de Manobra Subterrânea) seja operada exclusivamente pelo COD.
*   **Exemplo ❌:** Ação MA60 atribuída ao executor 'Tecnico'.

#### Regra 38 (Equipamentos Manuais vs COD)
Em etapas de manobra com equipes presentes, impede que equipamentos não telecontrolados sejam operados pelo COD.
*   **Exemplo ❌:** Chave manual (não tele) sendo aberta pelo COD quando há equipe em campo.
