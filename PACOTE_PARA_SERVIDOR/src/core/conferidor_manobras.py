...
def main(manobra_param=None, usuario_param=None, senha_param=None, headless=False, log_func=print, dados_equipamentos_cache=None):
    ...
    def print(*args, **kwargs):
        ...
        if log_func == globals().get('__builtins__', {}).get('print'):
            return
    ...
    with sync_playwright() as p:
        ...
        # O resto do código (Etapa A, B, etc) continua aqui...
        # Ao final de tudo, precisamos fechar o browser.
        # Vou procurar onde o motor termina para fechar o browser.
        ...
        solicitacao_bloqueio_ra = page.evaluate("""() => {
            ...
            return null; // Retorna null para forçar o fallback da Aba Manobra se houver dúvida
        }""")
